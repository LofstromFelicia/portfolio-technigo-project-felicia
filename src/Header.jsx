  ...
  return (
    <>
      <header className="hero-section pinned-block">
        <span className="block-pin pin-top-center" aria-hidden="true">📌</span>
        ...
        <div className="hero-text-content">
          ...
          <div className="hero-avatar-container">
            ...
            <span className="animated-emoji hero-avatar-sunflower" aria-hidden="true">🌻</span>
          </div>
      ...
      <div className="hero-socials">
        <a
          href="https://github.com/LofstromFelicia" target="_blank"
          rel="noopener noreferrer" className="sticker-github"
          title="GitHub"
        >
          <img src="/github-sticker.png" alt="Github" />
        </a>
        <a href="https://www.linkedin.com/in/felicia-löfström-693390130"
          target="_blank"
          rel="noopener noreferrer" className="sticker-linkedin"
          title="LinkedIn"
        >
